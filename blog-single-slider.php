        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-title">
            		<h1>Blog Single Slider</h1>
                </div>
            </div>
            <div class="col-md-6">
                <ol class="breadcrumb justify-content-md-end">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Blog Single Slider</li>
                </ol>
            </div>
        </div>
    </div><!-- END CONTAINER-->
    	...
    	<div class="row">
    		<div class="col-lg-8">
            	<div class="single_post">
                    <div class="blog_img">
                    	<div class="carousel_slider owl-carousel owl-theme nav_style4" data-nav="true" data-dots="false" data-autoheight="true" data-autoplay="true" data-loop="true" data-autoplay-timeout="3000" data-items="1">
                        	<div class="item">
